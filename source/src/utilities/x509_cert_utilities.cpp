...
//#include "cpprest/details/cpprest_compat.h" --- OPEN TODO:: include everywhere????
//#include "cpprest/details/basic_types.h"
#if defined(_WIN32) // --- mrkkrj
...
bool verify_X509_cert_chain(const std::vector<std::string> &certChain, const std::string &)
{
    ...
    LPSTR usages [] =
    {
        (char*) szOID_PKIX_KP_SERVER_AUTH, // mrkkrj --- OPEN TODO::: better way than (char*)???

        // For older servers and to match IE.
        (char*) szOID_SERVER_GATED_CRYPTO, // mrkkrj --- OPEN TODO::: better way???
        (char*) szOID_SGC_NETSCAPE         // mrkkrj --- OPEN TODO::: better way???
    };
